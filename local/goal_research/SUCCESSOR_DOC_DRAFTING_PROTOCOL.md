...
Every successor doc uses these common inputs. Temporary v136 provenance files
are excluded from this common list:
...
- absorbed v136 route decisions as represented in corrected local docs and the
  topology blueprint
...
every successor doc. Use it only as optional provenance, and only if a
source/route conflict or missing represented route decision is suspected and a
provenance copy is available.
