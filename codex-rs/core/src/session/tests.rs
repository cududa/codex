...
// REVIEW-DEDELUGER-INCOMING-DIFF path=codex-rs/core/src/session/tests.rs block=2
// @@ -1,47 +1,7 @@
    ...
    assert!(
        pending_input.iter().any(|item| {
            matches!(
                item,
// REVIEW-DEDELUGER: preserved maintained content; incoming upstream difference follows.
// REVIEW-DEDELUGER-INCOMING-DIFF path=codex-rs/core/src/session/tests.rs block=4
// @@ -1,14 +1,9 @@
