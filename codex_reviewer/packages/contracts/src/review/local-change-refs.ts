...
import { GitShaSchema, IdSchema, IsoDateTimeSchema, MarkdownStringSchema, NonEmptyStringSchema } from "../shared/primitives.js";

export const LocalChangeRefSchema = z
  .object({
    ...
    summary: MarkdownStringSchema.optional().describe("Optional summary of how the local change resolves the review work."),
...
export const LocalChangeRefsSchema = z
  .array(LocalChangeRefSchema)
  .describe("Local change references linked to a review item.");

export type LocalChangeRef = z.infer<typeof LocalChangeRefSchema>;
