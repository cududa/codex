...
export const createdAtColumn = () => integer("created_at", { mode: "number" }).notNull().default(sqliteUnixSecondsNow);
export const updatedAtColumn = () => integer("updated_at", { mode: "number" });
