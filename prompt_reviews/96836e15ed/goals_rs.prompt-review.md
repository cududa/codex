...
target: "goals_rs"
source:
  before: c03eb20d8dacf7bdf237a0688d969d95c67048fe:codex-rs/core/src/goals.rs
  after: 96836e15ed0db0123302debd064c857af0fe8c8b:codex-rs/core/src/goals.rs
---
...
id: same-003
kind: same
beforeLines: 1323-1404
afterLines: 1319-1400
-->
...
id: change-003
kind: change
beforeLines: 1405-1408
afterLines: 1401-1404
-->
...
id: same-004
kind: same
beforeLines: 1409-1418
afterLines: 1405-1414
-->
...
id: same-005
kind: same
beforeLines: 1420-1424
afterLines: 1415-1419
-->
...
id: same-006
kind: same
beforeLines: 1426-1461
afterLines: 1420-1455
-->
...
id: same-009
kind: same
beforeLines: 1466-1525
afterLines: 1465-1524
-->
...
id: same-010
kind: same
beforeLines: 1526-1529
afterLines: 1526-1529
-->

```text id=same-010 side=both
...
id: same-011
kind: same
beforeLines: 1530-1588
afterLines: 1532-1590
-->

```text id=same-011 side=both
    use codex_protocol::protocol::ThreadGoal;
    use codex_protocol::protocol::ThreadGoalStatus;
    use codex_protocol::protocol::TokenUsage;
    use std::time::Duration;
...
id: same-012
kind: same
beforeLines: 1590-1613
afterLines: 1592-1615
-->

```text id=same-012 side=both
...
id: same-013
kind: same
beforeLines: 1615-1621
afterLines: 1617-1623
-->

```text id=same-013 side=both
        assert!(prompt.contains("Token budget: 10000"));
...
id: same-015
kind: same
beforeLines: 1624-1652
afterLines: 1642-1670
-->

```text id=same-015 side=both
